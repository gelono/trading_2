...
from trading_2.testing.condition_signals import WorkPeriodCrossMAEarly, ImpulsPeriodDirection, \
    ...
    WorkPeriodCrossMAEarlyOrLate, WorkPeriodExtremumToMAFilter, StrategicPeriodFilter
...
# stop_position_rule = StopOrderBehindExtremum()
...
test = Test(test_data, "2023-06-12 03:00:00", "2025-06-10 03:00:00")

test.test(list_enter_conditions, deltas_dict, base_process_trade, "buy", test_service, stop_position_rule=stop_position_rule,
          profit_position_rule=profit_position_rule, close_lose_position=None, close_profit_position=None, time_close_check=False)

test.test(list_enter_conditions, deltas_dict, base_process_trade, "sell", test_service, stop_position_rule=stop_position_rule,
          profit_position_rule=profit_position_rule, close_lose_position=None, close_profit_position=None, time_close_check=False)
